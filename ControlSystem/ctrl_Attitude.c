...
/*模式及期望*/
	...
	bool Attitude_Control_Enable()
	{
		...
		/*初始化*/
			...
			//初始化姿态ESO
			init_ESO_AngularRate( &ESO[0] , Cfg_get_MotorT(0) , Cfg_get_RPYCtrl_b(0) , 0.7f , 10 , 500 , 5000 );
			init_ESO_AngularRate( &ESO[1] , Cfg_get_MotorT(1) , Cfg_get_RPYCtrl_b(1) , 0.7f , 10 , 500 , 5000 );
